import { getWall, getBarrier } from '/Purr-petual/Objects/wall.js';
import { getFood } from '/Purr-petual/Objects/food.js';
import { getSeeker } from '/Purr-petual/Objects/seeker.js';
import { getCloset } from '/Purr-petual/Objects/closet.js';
import { getFoodBox } from '/Purr-petual/Objects/foodBox.js';

import { getRandomInt, getRandomFloat, setStringSeed, isChance } from '/Purr-petual/Helpers/random.js';
import { getRotatedDirection, getPath } from '/Purr-petual/math.js';
...
export function generateScattered(objects, getEmptyPos, getBoolWorldRepresentation, player) {
	const numCells = 9;
	const gridScaleRate = numCells / 8;
	const cellsSize = 300;
	...
	let worldGrid = getBoolWorldRepresentation(200 * gridScaleRate);
...
export function generateTest(objects, _, __, player) {
	objects.walls.push(getWall(
