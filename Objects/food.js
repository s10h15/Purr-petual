import { getRandomInt, isChance } from "/Helpers/random.js";
...
export function getFood(x, y) {
	...
	return {
		...
		update(player) {
			...
			/*if (magnitude != 0 && magnitude < player.radius + 50) {
				dirX /= magnitude;
				dirY /= magnitude;
				const speed = Math.max(25, magnitude);
				this.x += (dirX / speed) * 50;
				this.y += (dirY / speed) * 50;
